      ...
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6 sm:mb-8">
          <div class="flex items-center gap-2 text-xs sm:text-sm text-gray-600 mb-4">
            ...
            <span>/</span>
            <span class="text-gray-900">Edit {{ metric.label_en }}</span>
          </div>
          <h2 class="text-xl sm:text-2xl font-bold text-gray-900">Edit Impact Metric</h2>
          <p class="text-sm sm:text-base text-gray-600 mt-1">Update the statistic displayed on the About page</p>
        </div>
...
const form = ref({
  ...
  order: props.metric.order,
  is_active: props.metric.is_active,
});
...
const submitForm = () => {
  ...
  router.put(`/admin/impact-metrics/${props.metric.id}`, form.value, {
    onFinish: () => {
