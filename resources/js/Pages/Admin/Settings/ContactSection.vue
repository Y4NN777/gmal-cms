<template>
  <div class="p-6">
    <h3 class="text-xl font-semibold text-gray-900 mb-6">{{ t('admin.settingsPage.contact.title') }}</h3>
      ...
      <div>
        <label for="contact_email" class="block text-sm font-medium text-gray-700 mb-2">
          <span class="flex items-center gap-2">
            ...
            {{ t('admin.settingsPage.contact.email') }}
          </span>
        </label>
        <input
          id="contact_email"
          ...
          :placeholder="t('admin.settingsPage.contact.emailPlaceholder')"
        />
      </div>
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">
          <span class="flex items-center gap-2">
            ...
            {{ t('admin.settingsPage.contact.phoneNumbers') }}
          </span>
        </label>
        <div class="space-y-2">
          <div v-for="(phone, index) in phoneNumbers" :key="index" class="flex items-center gap-2">
            <input
              ...
              :placeholder="index === 0 ? t('admin.settingsPage.contact.phonePlaceholder1') : t('admin.settingsPage.contact.phonePlaceholder2')"
            />
            <button
              ...
              :title="t('admin.settingsPage.contact.remove')"
            >
        ...
        >
          ...
          {{ t('admin.settingsPage.contact.addPhone') }}
        </button>
      </div>
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">
          <span class="flex items-center gap-2">
            ...
            {{ t('admin.settingsPage.contact.locations') }}
          </span>
        </label>
        <div class="space-y-3">
          <div v-for="(address, index) in addresses" :key="index" class="border border-gray-200 rounded-lg p-4">
            <div class="flex items-start gap-3">
              <div class="flex-1 space-y-3">
                ...
                <div>
                  <label class="block text-xs font-medium text-gray-600 mb-1">{{ t('admin.settingsPage.contact.country') }}</label>
                  <select
                  ...
                  >
                    <option value="">{{ t('admin.settingsPage.contact.selectCountry') }}</option>
