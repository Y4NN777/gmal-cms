    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
          <a href="/admin/gallery" class="hover:text-orange-600 transition-colors">Gallery</a>
          <span>/</span>
          <span class="text-gray-900 font-medium">Edit Album</span>
        </div>
        <div class="flex justify-between items-start">
          <div>
            <h2 class="text-3xl font-bold text-gray-900">{{ album.title }}</h2>
            <p class="text-gray-600 mt-2">Manage album details and images</p>
          </div>
          <button
      ...
      <form @submit.prevent="submitForm" class="bg-white rounded-xl shadow-sm p-6 mb-8">
        <h3 class="text-lg font-semibold text-gray-900 mb-6">Album Information</h3>
      ...
      <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex justify-between items-center mb-6">
          <div>
            ...
            <p class="text-sm text-gray-600 mt-1">{{ images?.length || 0 }} image(s) in this album</p>
          </div>
